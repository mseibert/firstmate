...
# Both PR-opening definitions of done also make the five-lens gate mandatory: the
# worker runs the five lenses over the branch diff and records each lens's result,
# in the PR body for direct-PR and in one designated PR comment for no-mistakes.
