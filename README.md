...
- [docs/cognee-memory-bridge.md](docs/cognee-memory-bridge.md) - the lean Cognee memory bridge: query stored memory before a task and feed relevant entries into the brief as context.
