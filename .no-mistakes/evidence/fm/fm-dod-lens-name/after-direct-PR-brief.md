...
1. First action: create your branch: `git checkout -b fm/dod-lens-direct`

# Rules
1. Never push to the default branch (push only your `fm/dod-lens-direct` branch). Never merge a PR.
2. Stay inside this worktree; modify nothing outside it.
3. Use gh-axi for GitHub operations and chrome-devtools-axi for browser operations.
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-dod-lens.5v1Zmh/home/state/dod-lens-direct.status'`
...
Firstmate steers you through durable message files in '/tmp/fm-dod-lens.5v1Zmh/home/state/dod-lens-direct.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/tmp/fm-dod-lens.5v1Zmh/home/state/dod-lens-direct.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/fm-dod-lens.5v1Zmh/home/state/dod-lens-direct.inbox'/NNN.msg '/tmp/fm-dod-lens.5v1Zmh/home/state/dod-lens-direct.inbox'/handled/`.
