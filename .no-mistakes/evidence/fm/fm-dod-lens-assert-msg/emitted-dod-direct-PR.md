...
1. First action: create your branch: `git checkout -b fm/five-lens-dpr`

# Rules
1. Never push to the default branch (push only your `fm/five-lens-dpr` branch). Never merge a PR.
2. Stay inside this worktree; modify nothing outside it.
3. Use gh-axi for GitHub operations and chrome-devtools-axi for browser operations.
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/tmp.Q0x8kCybpc/home/state/five-lens-dpr.status'`
...
Firstmate steers you through durable message files in '/tmp/tmp.Q0x8kCybpc/home/state/five-lens-dpr.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/tmp/tmp.Q0x8kCybpc/home/state/five-lens-dpr.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/tmp.Q0x8kCybpc/home/state/five-lens-dpr.inbox'/NNN.msg '/tmp/tmp.Q0x8kCybpc/home/state/five-lens-dpr.inbox'/handled/`.
