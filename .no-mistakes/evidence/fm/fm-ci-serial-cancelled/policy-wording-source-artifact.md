Verbatim copy of the source artifact section that carries the policy wording into this change.
Source: docs/fm-test-portable-shards.md (section 'Cancelled checks are not red CI').
The captain's own copy lives at ~/.claude/pr-policy.md; it is captain-private and is not edited from this repo.
