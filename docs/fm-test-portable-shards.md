...
A script with no hint gets the conservative `PORTABLE_SERIAL_DEFAULT_WEIGHT_MS` default; the current 159-script lane has two such scripts, bringing its assignment weight to 4981598 ms.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of5` | 30 | 996312 ms (~16.61 min) |
| `portable-serial-2of5` | 32 | 996314 ms (~16.61 min) |
| `portable-serial-3of5` | 32 | 996311 ms (~16.61 min) |
| `portable-serial-4of5` | 32 | 996322 ms (~16.61 min) |
| `portable-serial-5of5` | 33 | 996339 ms (~16.61 min) |
| imbalance | | 28 ms |
