...
A script with no hint gets the conservative `PORTABLE_SERIAL_DEFAULT_WEIGHT_MS` default; the current 156-script lane has twelve such scripts, bringing its assignment weight to 4171689 ms.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of5` | 30 | 834332 ms (~13.91 min) |
| `portable-serial-2of5` | 31 | 834330 ms (~13.91 min) |
| `portable-serial-3of5` | 32 | 834347 ms (~13.91 min) |
| `portable-serial-4of5` | 32 | 834342 ms (~13.91 min) |
| `portable-serial-5of5` | 31 | 834338 ms (~13.91 min) |
| imbalance | | 17 ms |
