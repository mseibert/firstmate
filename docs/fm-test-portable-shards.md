...
A script with no hint gets the conservative `PORTABLE_SERIAL_DEFAULT_WEIGHT_MS` default; the current 161-script lane has two such scripts, bringing its assignment weight to 4983468 ms.
...
| Lane | Script count | Estimated duration |
|---|---:|---:|
| `portable-serial-1of5` | 32 | 996717 ms (~16.61 min) |
| `portable-serial-2of5` | 31 | 996683 ms (~16.61 min) |
| `portable-serial-3of5` | 32 | 996684 ms (~16.61 min) |
| `portable-serial-4of5` | 33 | 996685 ms (~16.61 min) |
| `portable-serial-5of5` | 33 | 996699 ms (~16.61 min) |
| imbalance | | 34 ms |
